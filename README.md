There are some small python projects inside the folder which you can call it a large project(named 'python_small_projects') , you can download the zip file to decompress .
